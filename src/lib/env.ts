...
function readOptionalUrlEnv(name: string, fallback: string): string {
...
export const appEnv = {
  ...
  hasSupabaseConfig:
    readOptionalEnv("VITE_SUPABASE_URL") !== "" &&
    readOptionalEnv("VITE_SUPABASE_PUBLISHABLE_KEY") !== "",
  supabaseUrl: readOptionalUrlEnv("VITE_SUPABASE_URL", "https://example.supabase.co"),
  supabasePublishableKey:
    readOptionalEnv("VITE_SUPABASE_PUBLISHABLE_KEY") || "local-offline-placeholder",
